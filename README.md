...
| <a name="input_backup_policy_status"></a> [backup\_policy\_status](#input\_backup\_policy\_status) | (Required) A status of the backup policy. Valid values: `ENABLED`, `DISABLED`. | `string` | `"ENABLED"` | no |
...
| <a name="input_file_system_policy"></a> [file\_system\_policy](#input\_file\_system\_policy) | (Required) The JSON formatted file system policy for the EFS file system. | `string` | `""` | no |
...
| <a name="input_mount_target_ip_addresses"></a> [mount\_target\_ip\_addresses](#input\_mount\_target\_ip\_addresses) | The addresses (within the address range of the specified subnet) at which the file system may be mounted via the mount target. | `list(string)` | `[]` | no |
| <a name="input_mount_target_subnet_ids"></a> [mount\_target\_subnet\_ids](#input\_mount\_target\_subnet\_ids) | (Required) The IDs of subnets to add the mount target in. | `list(string)` | `[]` | no |
